    ...
    <section className="relative w-full h-screen overflow-hidden bg-[#030303] flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-5xl px-6 text-center">
        ...
        <motion.div
          ...
          transition={{ duration: 1, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}
          className="mt-8 md:mt-12 max-w-3xl mx-auto flex flex-col items-center text-center"
        >
          <p className="text-[#f0ede8]/70 font-serif text-sm sm:text-base md:text-lg leading-relaxed italic max-w-xl">
            If you are interested in Startup Foundry, make sure to register by clicking the link below.
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSdVBHCEojiKZQrEvNoaiggGjnbN8dPKi-Fe-cVWLXhtQxfWuA/viewform?usp=sharing&ouid=117406261044074584609" target='_blank' className="w-full sm:w-auto">
